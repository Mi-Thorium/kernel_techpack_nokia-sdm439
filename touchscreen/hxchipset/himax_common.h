...
#define HX_USB_DETECT_GLOBAL                    /*open this macro ,FW can reduce sensitivity,can reduce interference---is opened by tanwenchao.wt */ 
...
#endif
#endif
//end,compatible both 89571 and 89626 tp , added by tanwenchao.wt,20190121
...
struct himax_ts_data
{
    ...
    struct workqueue_struct *himax_resume_wq;
